class QuestionService {
  ...
  async fetchQuestions() {
    ...
    this.questions = [
      ...
      {
        id: '6',
        question: "Raynaud's symptoms have caused feelings of despair / loss of hope",
        answers: [
          'Not at all',
          'A little bit',
          'Somewhat',
      ...
      {
        id: '7',
        question: "Being unabale to do normal things becasue of Raynaud's sympotoms has bothered me",
        answers: [
          'Not at all',
          'A little bit',
          'Somewhat',
